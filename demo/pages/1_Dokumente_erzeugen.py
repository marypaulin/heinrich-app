...
def run_rechnung():
    ...
    project_number = st.session_state.get("project_number_rechnung", "").strip()
    ...
    try:
        st.session_state.rechnung_info.append("Starte Rechnung/Auftragsbestätigung")
        ...
        st.session_state.rechnung_info.append("DOCX erzeugt: Auftragsbestätigung.docx")
        st.session_state.rechnung_info.append("PDF erzeugt: Rechnung.pdf")
        st.session_state.rechnung_info.append("PDF erzeugt: Auftragsbestätigung.pdf")
